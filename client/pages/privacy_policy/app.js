...
const PrivacyPolicy = () => {
    return (
        <div className="bg-primaries-700 min-h-screen py-5 md:py-10">
            <Head>
            ...
            <div className={`text-primaries-100 px-4 sm:px-8 md:px-12 lg:px-16`}>
                <h1 className=' font-bold text-5xl  mb-5'>Privacy Policy</h1>
                ...
                <p className='mt-1'>This Privacy Policy describes Our policies and procedures on the collection, use and disclosure of Your
                    ...
                    You.</p>
                <p className='mt-1'>We use Your Personal data to provide and improve the Service. By using the Service, You agree to the
                    collection and use of information in accordance with this Privacy Policy.</p>
                <h1 className=' font-bold text-5xl mt-5 mb-5'>Interpretation and Definitions</h1>
                <h2 className=' font-semibold text-3xl mt-5 mb-5'>Interpretation</h2>
                <p className='mt-1'>The words of which the initial letter is capitalized have meanings defined under the following
                ...
                <h2 className=' font-semibold text-3xl mt-5 mb-5'>Definitions</h2>
                <p className='mt-1'>For the purposes of this Privacy Policy:</p>
                <ul className='list-disc ml-8'>
                    <li>
                        <p className='mt-1'><strong>Account</strong> means a unique account created for You to access our Service or parts of
                            our Service.</p>
                    </li>
                    <li>
                        <p className='mt-1'><strong>Company</strong> (referred to as either &quot;the
                            Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to
                            PICT ACM Student Chapter, PICT, Pune, Maharashtra-411043.</p>
                    </li>
                    <li>
                        <p className='mt-1'><strong>Cookies</strong> are small files that are placed on Your computer, mobile device or any
                            other device by a website, containing the details of Your browsing history on that website among
                            its many uses.</p>
                    </li>
                    <li>
                        <p className='mt-1'><strong>Country</strong> refers to: Maharashtra, India</p>
                    </li>
                    <li>
                        <p className='mt-1'><strong>Device</strong> means any device that can access the Service such as a computer, a
                            cellphone or a digital tablet.</p>
                    </li>
                    <li>
                        <p className='mt-1'><strong>Personal Data</strong> is any information that relates to an identified or identifiable
                            individual.</p>
                    </li>
                    <li>
                        <p className='mt-1'><strong>Service</strong> refers to the Website.</p>
                    </li>
                    <li>
                        <p className='mt-1'><strong>Service Provider</strong> means any natural or legal person who processes the data on
                    ...
                    <li>
                        <p className='mt-1'><strong>Third-party Social Media Service</strong> refers to any website or any social network
                            website through which a User can log in or create an account to use the Service.</p>
                    </li>
                    <li>
                        <p className='mt-1'><strong>Usage Data</strong> refers to data collected automatically, either generated by the use
                    ...
                    <li>
                        <p className='mt-1'><strong>You</strong> means the individual accessing or using the Service, or the company, or
                            other legal entity on behalf of which such individual is accessing or using the Service, as
                            applicable.</p>
                    </li>
                </ul>
                <h1 className=' font-bold text-5xl mt-5 mb-5'>Collecting and Using Your Personal Data</h1>
                <h2 className=' font-semibold text-3xl mt-5 mb-5'>Types of Data Collected</h2>
                <h3 className=' font-semibold text-2xl mt-5 mb-5'>Personal Data</h3>
                <p className='mt-1'>While using Our Service, We may ask You to provide Us with certain personally identifiable information
                ...
                <ul className='list-disc ml-8'>
                    ...
                    <li>
                        <p className='mt-1'>Usage Data</p>
                    </li>
                </ul>
                <h3 className=' font-semibold text-2xl mt-5 mb-5'>Usage Data</h3>
                <p className='mt-1'>Usage Data is collected automatically when using the Service.</p>
                <p className='mt-1'>Usage Data may include information such as Your Device's Internet Protocol address (e.g. IP address),
                    browser type, browser version, the pages of our Service that You visit, the time and date of Your visit,
                    the time spent on those pages, unique device identifiers and other diagnostic data.</p>
                <p className='mt-1'>When You access the Service by or through a mobile device, We may collect certain information
                ...
                <p className='mt-1'>We may also collect information that Your browser sends whenever You visit our Service or when You access
                    the Service by or through a mobile device.</p>
                <h3 className=' font-semibold text-2xl mt-5 mb-5'>Tracking Technologies and Cookies</h3>
                <p className='mt-1'>We use Cookies and similar tracking technologies to track the activity on Our Service and store certain
                ...
                <p className='mt-1'>Cookies can be &quot;Persistent&quot; or &quot;Session&quot; Cookies. Persistent Cookies remain on Your
                    ...
                    close Your web browser. Learn more about cookies: <a
                        href="https://www.freeprivacypolicy.com/blog/cookies/" target="_blank" rel="noreferrer" className='text-blue-600'>Cookies: What Do They Do?</a>.
                </p>
                <p className='mt-1'>We use both Session and Persistent Cookies for the purposes set out below:</p>
                <ul className='list-disc ml-8'>
                    <li>
                        <p className='mt-1'><strong>Necessary / Essential Cookies</strong></p>
                        <p className='mt-1'>Type: Session Cookies</p>
                        <p className='mt-1'>Administered by: Us</p>
                        <p className='mt-1'>Purpose: These Cookies are essential to provide You with services available through the Website
                    ...
                    <li>
                        <p className='mt-1'><strong>Cookies Policy / Notice Acceptance Cookies</strong></p>
                    ...
                    <li>
                        <p className='mt-1'><strong>Functionality Cookies</strong></p>
                        <p className='mt-1'>Type: Persistent Cookies</p>
                        <p className='mt-1'>Administered by: Us</p>
                        <p className='mt-1'>Purpose: These Cookies allow us to remember choices You make when You use the Website, such as
                ...
                <p className='mt-1'>For more information about the cookies we use and your choices regarding cookies, please visit our
                    Cookies Policy or the Cookies section of our Privacy Policy.</p>
                <h2 className=' font-semibold text-3xl mt-5 mb-5'>Use of Your Personal Data</h2>
                <p className='mt-1'>The Company may use Personal Data for the following purposes:</p>
                <ul className='list-disc ml-8'>
                    <li>
                        <p className='mt-1'><strong>To provide and maintain our Service</strong>, including to monitor the usage of our
                            Service.</p>
                    </li>
                    <li>
                        <p className='mt-1'><strong>To manage Your Account:</strong> to manage Your registration as a user of the Service.
                    ...
                    <li>
                        <p className='mt-1'><strong>For the performance of a contract:</strong> the development, compliance and undertaking
                    ...
                    <li>
                        <p className='mt-1'><strong>To contact You:</strong> To contact You by email, telephone calls, SMS, or other
                    ...
                    <li>
                        <p className='mt-1'><strong>To provide You</strong> with news, special offers and general information about other
                    ...
                    <li>
                        <p className='mt-1'><strong>To manage Your requests:</strong> To attend and manage Your requests to Us.</p>
                    </li>
                    <li>
                        <p className='mt-1'><strong>For business transfers:</strong> We may use Your information to evaluate or conduct a
                    ...
                    <li>
                        <p className='mt-1'><strong>For other purposes</strong>: We may use Your information for other purposes, such as data
                ...
                <p className='mt-1'>We may share Your personal information in the following situations:</p>
                <ul className='list-disc ml-8'>
                ...
                <h2 className=' font-semibold text-3xl mt-5 mb-5'>Retention of Your Personal Data</h2>
                <p className='mt-1'>The Company will retain Your Personal Data only for as long as is necessary for the purposes set out in
                ...
                <p className='mt-1'>The Company will also retain Usage Data for internal analysis purposes. Usage Data is generally retained
                    ...
                    periods.</p>
                <h2 className=' font-semibold text-3xl mt-5 mb-5'>Transfer of Your Personal Data</h2>
                <p className='mt-1'>Your information, including Personal Data, is processed at the Company's operating offices and in any
                    ...
                    jurisdiction.</p>
                <p className='mt-1'>Your consent to this Privacy Policy followed by Your submission of such information represents Your
                    agreement to that transfer.</p>
                <p className='mt-1'>The Company will take all steps reasonably necessary to ensure that Your data is treated securely and in
                ...
                <h2 className=' font-semibold text-3xl mt-5 mb-5'>Disclosure of Your Personal Data</h2>
                <h3 className=' font-semibold text-2xl mt-5 mb-5'>Business Transactions</h3>
                <p className='mt-1'>If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred.
                    We will provide notice before Your Personal Data is transferred and becomes subject to a different
                    Privacy Policy.</p>
                <h3 className=' font-semibold text-2xl mt-5 mb-5'>Law enforcement</h3>
                <p className='mt-1'>Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do
                    so by law or in response to valid requests by public authorities (e.g. a court or a government
                    agency).</p>
                <h3 className=' font-semibold text-2xl mt-5 mb-5'>Other legal requirements</h3>
                <p className='mt-1'>The Company may disclose Your Personal Data in the good faith belief that such action is necessary
                    to:</p>
                <ul className='list-disc ml-8'>
                ...
                <h2 className=' font-semibold text-3xl mt-5 mb-5'>Security of Your Personal Data</h2>
                <p className='mt-1'>The security of Your Personal Data is important to Us, but remember that no method of transmission over
                    the Internet, or method of electronic storage is 100% secure. While We strive to use commercially
                    acceptable means to protect Your Personal Data, We cannot guarantee its absolute security.</p>
                <h1 className=' font-bold text-5xl mt-5 mb-5'>Children's Privacy</h1>
                <p className='mt-1'>Our Service does not address anyone under the age of 13. We do not knowingly collect personally
                ...
                <p className='mt-1'>If We need to rely on consent as a legal basis for processing Your information and Your country requires
                    consent from a parent, We may require Your parent's consent before We collect and use that
                    information.</p>
                <h1 className=' font-bold text-5xl mt-5 mb-5'>Links to Other Websites</h1>
                <p className='mt-1'>Our Service may contain links to other websites that are not operated by Us. If You click on a third
                    party link, You will be directed to that third party's site. We strongly advise You to review the
                    Privacy Policy of every site You visit.</p>
                <p className='mt-1'>We have no control over and assume no responsibility for the content, privacy policies or practices of
                    any third party sites or services.</p>
                <h1 className=' font-bold text-5xl mt-5 mb-5'>Changes to this Privacy Policy</h1>
                <p className='mt-1'>We may update Our Privacy Policy from time to time. We will notify You of any changes by posting the new
                    Privacy Policy on this page.</p>
                <p className='mt-1'>We will let You know via email and/or a prominent notice on Our Service, prior to the change becoming
                    effective and update the &quot;Last updated&quot; date at the top of this Privacy Policy.</p>
                <p className='mt-1'>You are advised to review this Privacy Policy periodically for any changes. Changes to this Privacy
                    Policy are effective when they are posted on this page.</p>
                <h1 className=' font-bold text-5xl mt-5 mb-5'>Contact Us</h1>
                <p className='mt-1'>If you have any questions about this Privacy Policy, You can contact us:</p>
                <ul className='list-disc ml-8 mb-5'>
                    <li>By email: acm.pict@gmail.com</li>
                </ul>
                {/* <Footer /> */}
            </div>
        </div>
